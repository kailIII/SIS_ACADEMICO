class FuncionariosController < ApplicationController
  ...
  private
    ...
    def funcionario_params
      params.require(:funcionario).permit(:ci_fun, :nombres_fun, :apellidos_fun, :fnac_fun, :lnac_fun, :direccion_fun, :telefono_fun, :celular_fun, :email_fun, :est_civil_fun, :genero_fun, :nacionalidad_fun, :especialidad_fun)
    end
end
