class AlumnosController < ApplicationController
  ...
  private
    ...
    def alumno_params
      params.require(:alumno).permit(:ci_alu, :nombres_alu, :apellidos_alu, :fnac_alu, :lnac_alu, :direccion_alu, :telefono_alu, :celular_alu, :email_alu, :est_civil_alu, :genero_alu, :nacionalidad_alu, :procedencia_alu)
    end
end
