...
class SedesControllerTest < ActionController::TestCase
  ...
  test "should create sede" do
    assert_difference('Sede.count') do
      post :create, sede: { ciudad_id: @sede.ciudad_id, facu_carrera_id: @sede.facu_carrera_id, universidad_id: @sede.universidad_id }
    end
  ...
  test "should update sede" do
    patch :update, id: @sede, sede: { ciudad_id: @sede.ciudad_id, facu_carrera_id: @sede.facu_carrera_id, universidad_id: @sede.universidad_id }
    assert_redirected_to sede_path(assigns(:sede))
  end
