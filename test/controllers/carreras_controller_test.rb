...
class CarrerasControllerTest < ActionController::TestCase
  ...
  test "should create carrera" do
    assert_difference('Carrera.count') do
      post :create, carrera: { duracion_carr: @carrera.duracion_carr, nombre_carr: @carrera.nombre_carr, titulo_obt_carr: @carrera.titulo_obt_carr }
    end
  ...
  test "should update carrera" do
    patch :update, id: @carrera, carrera: { duracion_carr: @carrera.duracion_carr, nombre_carr: @carrera.nombre_carr, titulo_obt_carr: @carrera.titulo_obt_carr }
    assert_redirected_to carrera_path(assigns(:carrera))
  end
